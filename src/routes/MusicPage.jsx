        ...
        <div className='my-6 xl:px-72 px-10'>
            ...
            <div className='my-6'>
                ...
                <div className={!bop ? `hidden transition-all duration-100 ease-linear` : `transition-all duration-100 ease-linear`}>
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/p2mklRAs4JQ?si=7D-sCyAq9Kb-ByL4" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </div>
            </div>
            <div className="my-6">
                ...
                <div className={!dreamy ? `hidden transition-all duration-100 ease-linear` : `transition-all duration-100 ease-linear`}>
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/HfKa2YWX4L0?si=ahOX1opOoKDxi9U6" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                </div>
            </div>
